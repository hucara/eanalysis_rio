...
happySyn <- paste(happySyn, "+#Rio2016", sep="")
happy <- data.frame()
repeat
{
...
sadSyn <- paste(sadSyn, "+#Rio2016", sep="")
sad <- data.frame()
repeat
{
...
surprisedSyn <- paste(surprisedSyn, "+#Rio2016", sep="")
...
afraidSyn <- paste(afraidSyn, "+#Rio2016", sep="")
afraid <- data.frame()
repeat
{
...
angrySyn <- paste(angrySyn, "+#Rio2016", sep="")
angry <- data.frame()
repeat
{
...
disgustedSyn <- paste(disgustedSyn, "+#Rio2016", sep="")
...
write.csv(tweets, "./data/tweets_Rio2016.csv")
