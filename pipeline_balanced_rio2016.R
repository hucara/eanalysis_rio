...
# write.csv(tweets, file = "./data/tweets_Rio2016.csv")
...
train <- createCleanCorpus(tweets$cwtext[inTrain], sw)
test <- createCleanCorpus(tweets$cwtext[-inTrain], sw)
...
test.dtm <- DocumentTermMatrix(test)
train.dtm
test.dtm
...
# save(mtrain, file = "./mat/balanced_train_rio2016.Rdata")
# save(mtest, file = "./mat/balanced_test_rio2016.Rdata")
# save(train.y, file = "./mat/balanced_train_y_rio2016.Rdata")
# save(test.y, file = "./mat/balanced_test_y_rio2016.Rdata")
# save(train.dtm, file = "./mat/balanced_train_dtm_rio2016.Rdata")
# save(test.dtm, file = "./mat/balanced_test_dtm_rio2016.Rdata")
